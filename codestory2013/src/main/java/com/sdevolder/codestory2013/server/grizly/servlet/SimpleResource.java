...
public class SimpleResource {
    ...
    private final Logger log = Logger.getLogger(SimpleResource.class);
    private final DialogBot responseBot;
    ...
    public String answerMessage(@DefaultValue("") @QueryParam(PARAMETER_GET) String question) {
        return responseBot.getAnswer(question);
    }
